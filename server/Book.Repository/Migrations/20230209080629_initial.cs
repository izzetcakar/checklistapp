    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ControlLists", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: false),
                    CanList = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConseptId = table.Column<Guid>(type: "uuid", nullable: false),
                    CategoryId = table.Column<Guid>(type: "uuid", nullable: false),
                    SegmentId = table.Column<Guid>(type: "uuid", nullable: false),
                    ControlListId = table.Column<Guid>(type: "uuid", nullable: false),
                    Content = table.Column<string>(type: "text", nullable: false),
                    Standard = table.Column<int>(type: "integer", nullable: true),
                    Risk = table.Column<string>(type: "text", nullable: true),
                    ItemScore = table.Column<int>(type: "integer", nullable: true),
                    GoalScore = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListItems_ConseptId",
                table: "ListItems",
                column: "ConseptId");

            migrationBuilder.CreateIndex(
                name: "IX_ListItems_ControlListId",
                table: "ListItems",
                column: "ControlListId");

            migrationBuilder.CreateIndex(
                name: "IX_ListItems_SegmentId",
                table: "ListItems",
                column: "SegmentId");
